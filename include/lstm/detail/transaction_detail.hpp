...
LSTM_DETAIL_BEGIN
    ...
    public:
         ...
         */
        LSTM_NOINLINE_LUKEWARM var_storage rw_read(const var_base& src_var) const
        {
            assert(valid());
        ...
        rw_atomic_write(var_base& dest_var, const var_storage storage) const
        {
            assert(valid());
        ...
        LSTM_NOINLINE_LUKEWARM var_storage rw_untracked_read(const var_base& src_var) const
        {
            assert(valid());
         ...
         */
        LSTM_NOINLINE_LUKEWARM var_storage ro_read(const var_base& src_var) const
        {
            assert(valid());
        ...
        LSTM_NOINLINE_LUKEWARM var_storage ro_untracked_read(const var_base& src_var) const
        {
            assert(valid());
